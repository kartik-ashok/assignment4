...
//                   children: [
//                     // Results count
//                     if (provider.allBooks.isNotEmpty)
//                       Container(
//                         padding: EdgeInsets.symmetric(
//                           horizontal: 4.w,
//                           vertical: 2.h,
...
//                           children: [
//                             Text(
//                               'Found ${provider.allBooks.length} books',
//                               style: TextStyle(
//                                 fontSize: 14.sp,
//                                 color: Colors.grey[600],
//                                 fontWeight: FontWeight.w500,
...
//                               Text(
//                                 'Page ${(provider.allBooks.length ~/ 20) + 1}',
//                                 style: TextStyle(
//                                   fontSize: 12.sp,
//                                   color: Colors.grey[500],
//                                 ),
...
//                           if (index == provider.allBooks.length) {
//                             // Load more button
//                             return Container(
//                               padding: EdgeInsets.all(4.w),
//                               child: Center(
...
//                           final bookDoc = provider.allBooks[index];
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final provider = Provider.of<BookProvider>(context, listen: false);
      _searchController.text = "flutter"; // set your default search term
              ...
              children: [
                Expanded(
                  child: TextField(
                    ...
                    onSubmitted: (_) {}, // disable manual search
                    textInputAction: TextInputAction.search,
                  ),
                ),
              ],
